...
import { mock_topicInfo, mock_topic_item0, mock_topicMessages_p2 } from './mock_data'
...
describe('Topic', () => {
  ...
  it('render', async () => {
    ...
    jest.spyOn(APITopicInfo, "fetchTopicInfo").mockReturnValue(Promise.resolve(mock_topicInfo));
    jest.spyOn(APITopicMessages, "fetchTopicMessage").mockReturnValue(Promise.resolve(mock_topic_item0));
    jest.spyOn(APITopicMessages, "fetchTopicMessages").mockReturnValue(Promise.resolve(mock_topicMessages_p2));
