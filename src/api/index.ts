...
export const domainApi: string =
  localStorage.getItem("domain_api") || "https://react-mista-next.vercel.app";

export const urlTopicsList: string = "api/topics-list";
...
export const urlSections: string = localStorage.getItem("urlSections") || "api/sections";
